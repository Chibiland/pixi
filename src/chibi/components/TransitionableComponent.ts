...
export default abstract class TransitionableComponent<Name extends string, T, Target extends Container = Container> extends Component<Name, Target> implements VariableUpdatable {
